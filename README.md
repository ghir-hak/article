...
| --- | --- | --- |
| **Control plane ownership** | Provider-operated control plane for managed services | **You own/operate the platform** (or a trusted operator), on infrastructure you control |
